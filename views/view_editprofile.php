...
$(document).ready(function(){
	...
	if (width>640) {
		...
		$(".first").css({"float":"left", "position":"absolute","top":"2in","left":"2in","width":"5in"});
		$(".second").css({"float":"right","position":"absolute","top":"2.5in","right":"1in", "background-color":"white"});
		$(".name").css({"font-weight":"bold"});	
		$(".price, .err, .error").css({"color":"red"});	
		$(".newcustomer").css({"float":"left","position":"absolute","top":"1.5in","left":"2in","width":"5in"})
		$(".submit").css({"position":"relative","left":"1.5in"});
		$(".back").css({"position":"relative","bottom":"0.25in"});
	}else{
		$("body").css({"background-color": "#CCCCCC"});
...
<?php
	...
	if($updated = $this->session->userdata('updateprofile')){
		$success = "You profile has been updated.";
		$this->session->unset_userdata('updateprofile');
	}
...
<div class="newcustomer" id="newcustomer">
	...
	<form action="editprofile2" id="profile" method="POST">
	...
	<span class="submit"><input type="submit" id= "update" value="Update"></span>
</form>
	<span class="back"><a href="http://cs-server.usc.edu:19045/ci/index.php/con_kakaxi">Back</a></span>
</div>
